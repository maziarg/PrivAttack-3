...
import gym
import numpy as np
from sac import sac_core as core
import torch
...
def sac(trajectory_output_path, env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
